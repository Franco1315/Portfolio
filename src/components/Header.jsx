...
const Header = () => {
    return (
        <header className='flex flex-col min-h-screen relative'>
            <NavBar />
            {/* Contenedor header */}
            <div id='Aboutmi' className='px-5 lg:px-20 flex-grow w-full h-auto lg:h-[calc(100vh-90px)] flex lg:flex-row flex-col items-center relative overflow-hidden'>
                ...
                >
                    ...
                    <h2 className='text-3xl lg:text-5xl font-semibold leading-tight'>
                        <span className='text-secondary border-b-2 border-secondary inline-block'>María Franco</span><br />Fronted Developer<br /> and Web Designer
                    </h2>
                    <p className='w-full lg:w-[65%]'>Especializada en lenguajes HTML, CSS, JavaScript, framework React, entre otras herramientas y con experiencia avanzada en Figma para el diseño UX/UI.</p>
